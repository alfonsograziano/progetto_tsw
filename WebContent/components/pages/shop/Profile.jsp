...
<body>
	...
	<h4 class="nomargin"> <%out.print(user.getName()); %> <%out.print(user.getSurname());%></h4>
	<h6 class="nomargin">email: <%out.print(user.getEmail());%></h6>
	</div>
	...
	<p class="nomargin"><b>Contattaci su Whatsapp premendo sul pulsante</b></p>
