...
<body>
	...
	<div class="container">
		...
		<p>We use the Order Information that we collect generally to
		...
		<p>We share your Personal Information with third parties to help
			us use your Personal Information, as described above. For example, we
			...
			rights. [[INCLUDE IF USING REMARKETING OR TARGETED ADVERTISING]]</p>
		<h4>BEHAVIOURAL ADVERTISING</h4>
		<p>As described above, we use your Personal Information to provide
		...
		<p>Please note that we do not alter our Site's data collection and
			...
			Canada and the United States. DATA RETENTION When you place an order
			through the Site, we will maintain your Order Information for our
			records unless and until you ask us to delete this information.
			[[INSERT IF AGE RESTRICTION IS REQUIRED]] MINORS The Site is not
			intended for individuals under the age of [[INSERT AGE]].</p>
		</p>
		<h4>CHANGES</h4>
		...
		<p>For more information about our privacy practices, if you have
			...
			us by e-mail at betterhome.website@gmail.com or by mail using the
			details provided below: Via Roma 14, Salerno, 72, 84100, Italy</p>
	</div>
