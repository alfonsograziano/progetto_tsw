			...
			<div>
				...
				<form method="post"
					...
					<div class="wrap-row" style="align-items:center;">
						<div class="input-field">
						<select class="browser-default" name="order_state" id="order_state">
							<option value="1" <%if(order.getOrderState() == 1) out.print("selected");%>>Pending</option>
							<option value="2" <%if(order.getOrderState() == 2) out.print("selected");%>>Sent</option>
							<option value="3" <%if(order.getOrderState() == 3) out.print("selected");%>>Fulfilled</option>
							<option value="4" <%if(order.getOrderState() == 4) out.print("selected");%>>Deleted</option>
						</select> 
					</div>
